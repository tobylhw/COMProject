                ...
                <Box >
                    ...
                    <Box sx={{ p: 1 }}>
                        <Stack spacing={2} direction="row" sx={{ p: 0.5 }}>
                            ...
                            <Button variant="outlined" href="pages/loginwbar">Login with Elevate App Bar</Button>
                            <Button variant="outlined" href="pages/dbdemo">Dashboard layout</Button>
                        </Stack>
                        <Stack spacing={2} direction="row" sx={{ p: 0.5 }}>
                            <Button variant="outlined" href="pages/drawer">miniDrawer</Button>
