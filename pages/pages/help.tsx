                    ...
                    <Box sx={{ my: 1}}>
                        <Box sx={{ pl: 1 }}>
                            <Typography sx={{ my: 3 }} variant="h5" >
                                Please contact ITSC in office hour.<br />
                            </Typography>
                            <Typography sx={{ my: 2.5 }} variant="h6">ITSC Help Desk</Typography>
                            ...
                            <Typography sx={{ mt:2,mb: .5 }} variant="body1">
                                Opening Hours: <br />
                            </Typography>
                            <Typography sx={{ my: .5 }} variant="body1">
                            ...
                            <Typography sx={{ mt: 2, mb: .5 }} variant="body1">
                                Email: <br />
                                <Link sx={{ color:'#0072e5' }} href="mailto:itsc@hsu.edu.hk" underline="hover">
                                    {' itsc@hsu.edu.hk'}
                                </Link>
                            </Typography>
                        </Box>
