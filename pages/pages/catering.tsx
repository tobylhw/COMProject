            ...
            <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
                ...
                <TabPanel value={valueTab} index={0}>
                    <Typography variant="h5" >
                        Menu of Rendezvous at M Building (Choice of Dish) $27/$31
                    </Typography>
                    <Typography  >
                        Daily Soup, Hot or Soft Drink +$6<br/>Cold Drink +$7
                    </Typography>
                        <Box sx={{ minWidth: 500 }}>
                ...
                <TabPanel value={valueTab} index={1}>
                    ...
                    <Typography sx={{ my: 1, fontSize: 20 }}>
                        Breakfast Sets are served with coffee or tea{' '}
                    </Typography>
                    <DataGrid
                        autoHeight
