            ...
            <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
                ...
                <Box sx={{ my: 2, textAlign: 'center' }}>
                    <Box sx={{ p: 1 }}>
                        ...
                        <Typography sx={{ my: 1.5 }} variant="subtitle1">Group 11</Typography>
                        <Typography sx={{ my: 1.5 }} variant="body1">s186984 CAO Shuo<br/>s187184 CHAN Ho Lun<br/>s187208 LENUG Ho Wai</Typography>

                        <Typography sx={{ mt: 10 }} paragraph color="text.secondary">To start, please read the "readme.txt" in the .zip file.</Typography>
                        <Typography sx={{ fontSize: 50 }} paragraph color="text.secondary">( :</Typography>
                        <Typography paragraph color="text.secondary">Navigate by using the sidebar on the left.</Typography>
                    </Box>
                </Box>
            </Box>
        </Box>
