...
const shopItems = [
    ...
    {
        id: '11',
        title: 'Tomato & Cheese Packed Sandwiche',
        description: ' ',
        price: 26
    }
] as const;
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
                <DrawerHeader />
                <Typography sx={{ pl: 1 }} paragraph>
                    <Typography variant="h4" paragraph> A-Cafe Online Ordering <Button startIcon={<ShoppingCartIcon />} variant="outlined" onClick={handleClickOpenCartDialog('paper')}>Cart</Button> </Typography>
                    {shopItems.map(item => (
